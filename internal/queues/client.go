...
// acknowledgement: this module is taken and modified from amqp091-go `_examples`
...
func (client *Client) NotifyChannelClose(closeChan chan *amqp.Error) {
	client.channel.NotifyClose(closeChan)
}
